<div class="form-group col-md-6">
    ...
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->tender_no }}">
</div>

<div class="form-group col-md-6">
    <label>Tender Title</label>
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->title }}">
</div>

<div class="form-group col-md-6">
    <label>Procuring Authority</label>
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->procuring_authority }}">
</div>

<div class="form-group col-md-6">
    <label>End User</label>
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->end_user }}">
</div>

<div class="form-group col-md-6">
    <label>Publication Date</label>
    <input type="date" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->publication_date }}">
</div>

<div class="form-group col-md-6">
    <label>Submission Date</label>
    <input type="date" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->submission_date }}">
</div>

<div class="form-group col-md-6">
    <label>Financial Year</label>
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->tender->financial_year }}">
</div>

<div class="form-group col-md-6">
    <label><strong>Tender Specification Files</strong></label><br>
    @if (!empty($data->tenderProgress->tenderAwarded->tenderParticipate->tender->spec_file))
        <a class="form-control"
            href="{{ asset('uploads/documents/spec_files/' . $data->tenderProgress->tenderAwarded->tenderParticipate->tender->spec_file) }}"
            target="_blank">View
            Attachment</a>
    @else
...
<div class="form-group col-md-6">
    ...
    @if (!empty($data->tenderProgress->tenderAwarded->tenderParticipate->tender->notice_file))
        <a class="form-control"
            href="{{ asset('uploads/documents/notice_files/' . $data->tenderProgress->tenderAwarded->tenderParticipate->tender->notice_file) }}"
            target="_blank">View
            Attachment</a>
    @else
        <p class="text-muted">No attachment uploaded</p>
...
@php
    $statusLabel = match ($data->tenderProgress->tenderAwarded->tenderParticipate->tender->status) {
        0 => 'Pending',
        1 => 'Not Participated',
        2 => 'Participated',
        3 => 'Awarded',
    ...
    $submissionDateTime = \Carbon\Carbon::parse(
        $data->tenderProgress->tenderAwarded->tenderParticipate->tender->submission_date .
            ' ' .
            $data->tenderProgress->tenderAwarded->tenderParticipate->tender->submission_time,
    );

    if (
        $data->tenderProgress->tenderAwarded->tenderParticipate->tender->status === 0 &&
        $submissionDateTime->lt($now)
    ) {
        $statusLabel = 'Expired';
    }
@endphp
...
<div class="form-group col-md-6">
    ...
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->offer_no }}">
</div>

<div class="form-group col-md-6">
    <label>Offer Date</label>
    <input type="text" readonly class="form-control"
        value="{{ formatDateSafe($data->tenderProgress->tenderAwarded->tenderParticipate->offer_validity) }}">
</div>
...
<div class="form-group col-md-6">
    ...
    @if (!empty($data->tenderProgress->tenderAwarded->tenderParticipate->offer_doc))
        <a class="form-control"
            href="{{ asset('uploads/documents/offer_docs/' . $data->tenderProgress->tenderAwarded->tenderParticipate->offer_doc) }}"
            target="_blank">View
            Attachment</a>
    @else
        <p class="text-muted">No attachment uploaded</p>
...
<div class="form-group col-md-6">
    ...
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->is_bg == 1 ? 'Yes' : 'No' }}">
    <input type="hidden" name="is_bg"
        value="{{ $data->tenderProgress->tenderAwarded->tenderParticipate->is_bg }}">
</div>

<div class="w-100"></div>

@if ($data->tenderProgress->tenderAwarded->tenderParticipate->is_bg == 1)
    <div class="form-group col-md-6">
        <label for="bg_no">BG Number</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->bg_no ?? '-' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_in_bank">Issue in Bank</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->issue_in_bank ?? '-' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_in_branch">Issue in Branch</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->issue_in_branch ?? '-' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_date">BG Issue Date</label>
        <input type="date" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->issue_date ?? '' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="expiry_date">BG Expiry Date</label>
        <input type="date" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->expiry_date ?? '' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="amount">BG Amount</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->amount ?? '' }}"
            readonly>
    </div>
    <div class="form-group col-md-6">
        <label>BG Attachment</label><br>
        @if (!empty(optional($data->tenderProgress->tenderAwarded->tenderParticipate->bg)->attachment))
            <a class="form-control"
                {{ asset('uploads/documents/bg_attachments/' . $data->tenderProgress->tenderAwarded->tenderParticipate->bg->attachment) }}"
                target="_blank">
...
<div class="form-group col-md-6">
    ...
    <input type="text" readonly class="form-control"
        value="{{ $data->tenderProgress->tenderAwarded->is_pg == 1 ? 'Yes' : 'No' }}">
    <input type="hidden" name="is_pg" value="{{ $data->tenderProgress->tenderAwarded->is_pg }}">
</div>

<div class="w-100"></div>

@if ($data->tenderProgress->tenderAwarded->is_pg == 1)
    <div class="form-group col-md-6">
        <label for="bg_no">PG Number</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->pg_no ?? '-' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_in_bank">Issue in Bank</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->issue_in_bank ?? '-' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_in_branch">Issue in Branch</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->issue_in_branch ?? '-' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="issue_date">PG Issue Date</label>
        <input type="date" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->issue_date ?? '' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="expiry_date">PG Expiry Date</label>
        <input type="date" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->expiry_date ?? '' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label for="amount">PG Amount</label>
        <input type="text" class="form-control"
            value="{{ optional($data->tenderProgress->tenderAwarded->pg)->amount ?? '' }}" readonly>
    </div>
    <div class="form-group col-md-6">
        <label>PG Attachment</label><br>
        @if (!empty(optional($data->tenderProgress->tenderAwarded->pg)->attachment))
            <a class="form-control"
                href="{{ asset('uploads/documents/pg_attachments/' . $data->tenderProgress->tenderAwarded->pg->attachment) }}"
                target="_blank">
                View Current Attachment
            </a>
        @else
