...
@section('title', 'Edit Patient Emergency')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Edit Patient Emergency</h3>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('patient_emergencies.update', $patientEmergency) }}" method="POST"
                data-confirm="update">
                ...
                <div class="row">
                        ...
                        <select id="patientSelect" name="patient_id"
                            ...
                            @foreach ($patients as $patient)
                                <option value="{{ $patient->id }}"
                                    ...
                                    {{ old('patient_id', $patientEmergency->patient_id) == $patient->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <select name="is_emergency" id="is_emergency"
                            ...
                            <option value="1"
                                {{ old('is_emergency', $patientEmergency->is_emergency) == 1 ? 'selected' : '' }}>
                                Yes
                            </option>

                            <option value="0"
                                {{ old('is_emergency', $patientEmergency->is_emergency) == 0 ? 'selected' : '' }}>
                                No
                            </option>
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="datetime-local" name="emergency_date" id="emergency_date"
                            value="{{ old('emergency_date', optional($patientEmergency->emergency_date)->format('Y-m-d\TH:i')) }}"
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <textarea name="reason" id="reason" rows="5" class="form-control @error('reason') is-invalid @enderror"
                            placeholder="Write emergency details here...">{{ old('reason', $patientEmergency->reason) }}</textarea>
