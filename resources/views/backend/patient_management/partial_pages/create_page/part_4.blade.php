{{-- ========================= RECOMMENDED PATIENT ========================= --}}
<div class="patient-section-card" id="part_4_referral">
    <div class="section-header primary">
        ...
        <div class="section-content">
            ...
            <p class="mb-0">
                Record the referring doctor's information, referral notes and related documents.
            </p>
        </div>
    </div>
        ...
        <div class="recommend-section d-none">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <textarea name="referred_note" id="referred_note" class="form-control" rows="6">{{ old('referred_note') }}</textarea>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="global-upload-box">
                        ...
                        <input type="file" name="documents[]" class="form-control-file" accept=".pdf,image/*"
                            multiple>
