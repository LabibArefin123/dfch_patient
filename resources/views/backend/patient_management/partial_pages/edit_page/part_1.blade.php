...
<div class="form-group col-md-6">
    ...
    <input type="text" name="phone_1" class="form-control" value="{{ old('phone_1', $patient->phone_1) }}">
</div>

<div class="form-group col-md-6">
    <label>Patient's Phone 2</label>
    <input type="text" name="phone_2" class="form-control" value="{{ old('phone_2', $patient->phone_2) }}">
</div>

<div class="form-group col-md-6">
    <label>Patient's Father Phone</label>
    <input type="text" name="phone_f_1" class="form-control" value="{{ old('phone_f_1', $patient->phone_f_1) }}">
</div>

<div class="form-group col-md-6">
    <label>Patient's Mother Phone</label>
    <input type="text" name="phone_m_1" class="form-control" value="{{ old('phone_m_1', $patient->phone_m_1) }}">
</div>
