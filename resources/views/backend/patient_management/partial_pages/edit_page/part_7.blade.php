<div class="patient-section-card emergency-card" id="part_7_emergency">
        ...
        <div id="editEmergencySection" style="{{ old('is_emergency', $patient->is_emergency) ? '' : 'display:none;' }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <small class="text-muted">Select the patient's emergency admission date and time. </small>
                </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <small class="text-muted">Briefly describe why the patient required emergency treatment.</small>
                </div>
            </div>
        </div>
    </div>
