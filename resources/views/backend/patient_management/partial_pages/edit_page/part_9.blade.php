    ...
    <div class="patient-section-card patient-photo-card">
        <div class="section-header">
            <div>
                ...
                <span>Upload and manage patient profile image</span>
            </div>

            <span class="section-badge photo-badge">Profile </span>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-7">
                <div class="photo-info-box">
                    ...
                    <p>Update patient photo and view detailed image information.</p>
