    ...
    <div class="patient-section-card recommendation-card">
        <div class="patient-section-header recommendation-header">
            ...
            <div>
                ...
                <small>Patient treatment history and medical records</small>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="recommendation-detail">
                        ...
                        <strong>{{ $patient->treatment_type ?: 'N/A' }}</strong>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="recommendation-detail">
                        ...
                        <strong class="text-success">Treatment Available</strong>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <span>No treatment images available </span>
                    </div>
                @endif
            </div>
        </div>
