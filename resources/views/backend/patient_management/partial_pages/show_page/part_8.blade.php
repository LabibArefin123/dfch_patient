                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-8">
                        <div class="report-remarks">
                            <span> Remarks</span>
                            {{-- <p class="mb-0"> {{ $report->cancer_remarks ?: 'No remarks available' }}</p> --}}
                            <p class="mb-0"> {!! old('cancer_remarks', $report->cancer_remarks) !!}</p>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($report->xray_photo as $index => $photo)
                            <div class="cancer-image-card">
                                ...
                                <div class="cancer-image-description">
                                    ...
                                    <p class="mb-0">{{ $report->xray_description[$index] ?? 'N/A' }} </p>
                                </div>
                            </div>
                        @endforeach
                    </div>
