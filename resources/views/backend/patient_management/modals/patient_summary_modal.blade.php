            ...
            <div class="modal-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-7 d-flex flex-column" style="height: 694px;">
                        ...
                        <ul class="nav nav-tabs border-bottom px-3 pt-2 bg-light" id="patientSummaryTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active font-weight-bold" 
                                   id="results-tab" 
                                   data-toggle="tab" 
                                   data-bs-toggle="tab"
                                   href="#results-tab-pane" 
                                   role="tab" 
                        ...
                        <div class="tab-content flex-grow-1 overflow-auto bg-white">
                            ...
                            <div class="tab-pane fade show active p-3" id="results-tab-pane" role="tabpanel" aria-labelledby="results-tab">
