{{-- ===========================================================
| Premium Patient Document Viewer
=========================================================== --}}

<div id="documentImageOverlay" class="position-absolute w-100 h-100 d-none"
    style="
        top:0;
        left:0;
        z-index:9999;
    ...
    <div class="position-absolute w-100 px-4 py-3 d-flex align-items-center justify-content-between"
        ...
        <button id="closeDocumentImageOverlay" type="button"
    ...
    <div class="d-flex align-items-center justify-content-center h-100 px-5 py-4">
        ...
        <div class="position-relative rounded-4 overflow-hidden shadow-lg"
            ...
            <img id="documentOverlayImage" src="" class="img-fluid rounded"
                style="
                    max-height:82vh;
                    max-width:100%;
                    object-fit:contain;
