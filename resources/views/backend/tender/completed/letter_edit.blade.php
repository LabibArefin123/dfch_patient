...
@section('title', 'Completed Tender Letter Edit Page')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="mb-0">Edit Completed Tender Letter</h1>
        ...
        <div class="col">
            <div class="card border-warning shadow-sm">
                <div class="card-header bg-warning text-white py-2 d-flex justify-content-end align-items-center">
                    <a href="{{ route('completed_tenders.letter', $editLetter->tender_id) }}"
                        class="btn btn-sm btn-light text-dark">Cancel</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('completed_tenders.letter.update', $editLetter->id) }}" method="POST"
