...
@section('title', 'Completed Tender Letter')
...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="mb-0">Completed Tender Letter</h1>
        <a href="{{ route('completed_tenders.index') }}" class="btn btn-success btn-sm">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-secondary text-white py-2">
                    <strong>
                        Completed Letters for Tender →
                        {{ optional($tComplete->tenderProgress->tenderAwarded->tenderParticipate->tender)->title ?? '' }}
                        [{{ optional($tComplete->tenderProgress->tenderAwarded->tenderParticipate->tender)->tender_no ?? '' }}]
                    </strong>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table id="completedTable" class="table table-striped table-hover table-bordered mb-0">
                        ...
                        <tbody>
                            @forelse ($tenderLetters as $key => $letter)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('completed_tenders.letter.edit', $letter->id) }}"
                                            class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('completed_tenders.letter.destroy', $letter->id) }}"
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('completed_tenders.letter.store', $tenderId) }}" method="POST"
