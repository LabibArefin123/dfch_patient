...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="mb-0">Progress Tender Letter</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-secondary text-white py-2">
                    <strong>
                        Progress Letters for Tender →
                        {{ optional($tProgress->tenderAwarded->tenderParticipate->tender)->title ?? '' }}
                        [{{ optional($tProgress->tenderAwarded->tenderParticipate->tender)->tender_no ?? '' }}]
                    </strong>
                </div>
                ...
                <div class="card-body table-responsive p-0">
                    <table id="progressTable" class="table table-striped table-hover table-bordered mb-0">
                        ...
                        <tbody>
                            @forelse ($tenderLetters as $key => $letter)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('tender_progress.letter.edit', $letter->id) }}"
                                            class="btn btn-sm btn-warning">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('tender_progress.letter.destroy', $letter->id) }}"
        ...
        <div class="col-lg-4 mb-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('tender_progress.letter.store', $tenderId) }}" method="POST"
