<div class="wide-card">
    ...
    <div class="wide-content">
        ...
        @if ($specialistCard->show_designation)
            <div class="wide-designation">
                {{ $specialistCard->specialist->designation }}
            </div>
        @endif

        @if ($specialistCard->show_degree)
            <div class="wide-degree">
                {{ $specialistCard->specialist->degree }}
            </div>
        @endif

        @if ($specialistCard->show_details)
            <div class="wide-info-box">

                <div class="wide-detail-row">

                    <span class="wide-label">
                        Department
                    </span>

                    <span class="wide-value">
                        {{ $specialistCard->specialist->department ?? 'Specialist Department' }}
                    </span>
