...
@section('content')
    ...
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_front_layout.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_front_header.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_front_content.css') }}">
    {{-- CARD 2 CSS (Back Card) --}}
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_back_layout.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_back_header.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_back_content.css') }}">
    <link rel="stylesheet" href="{{ asset('css/backend/specialist_card/card_format/card_2/card_design_2_back_footer.css') }}">
