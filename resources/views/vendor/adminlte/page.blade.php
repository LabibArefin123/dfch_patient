...
<link rel="stylesheet" href="{{ asset('css/backend/global_css/01-layout.css') }}">

{{-- Navbar --}}
<link rel="stylesheet" href="{{ asset('css/backend/global_css/02-navbar.css') }}">

{{-- Global Components --}}
<link rel="stylesheet" href="{{ asset('css/backend/global_css/03-components.css') }}">

{{-- DataTables --}}
<link rel="stylesheet" href="{{ asset('css/backend/global_css/04-datatables.css') }}">

{{-- Global Search --}}
<link rel="stylesheet" href="{{ asset('css/backend/global_css/05-global-search.css') }}">

{{-- Animations --}}
<link rel="stylesheet" href="{{ asset('css/backend/global_css/06-animations.css') }}">
